...
export function render() {
  ...
  form.id = editor;
  form.innerHTML = `
    <h3 class="add-new-snackpost">Add New Snack</h3>
...
export function process(event) {
  ...
  if (!snackpost.title || !snackpost.content) {
